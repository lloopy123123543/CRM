...
<div id="drawer-navigation" className="fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform -transform-none -translate-x-full bg-Five border-r-4 border-Main"  aria-labelledby="drawer-navigation-label">
  ...
  <div className="py-4 overflow-y-auto">
      <ul className="space-y-2 font-medium">
         <li>
            <div  className="flex items-center p-2 text-Fourth rounded-lg  hover:bg-Third ">
         ...
         <li>
            <button type="button" className="flex items-center w-full p-2 text-Fourth transition duration-75 rounded-lg group hover:bg-Third" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                  <svg aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-Fourth transition duration-75 group-hover:text-Fourth" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clipRule="evenodd"></path></svg>
            ...
            <ul id="dropdown-example" className="hidden py-2 space-y-2">
                  <li>
                     <div  className="flex items-center w-full p-2 text-Fourth transition duration-75 rounded-lg pl-11 group hover:bg-Third ">Products</div>
                  </li>
                  <li>
                     <div  className="flex items-center w-full p-2 text-Fourth transition duration-75 rounded-lg pl-11 group hover:bg-Third ">Billing</div>
                  </li>
                  <li>
                     <div  className="flex items-center w-full p-2 text-Fourth transition duration-75 rounded-lg pl-11 group hover:bg-Third ">Invoice</div>
                  </li>
            </ul>
         </li>
         <li>
         ...
         <li>
            <div  className="flex items-center p-2 text-Fourth rounded-lg  hover:bg-Third ">
               <svg aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-Fourth transition duration-75  group-hover:text-Fourth" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd"></path></svg>
         ...
         <li>
         <Link href={'/'}><div  className="flex items-center p-2 text-Fourth rounded-lg  hover:bg-Third ">
               <svg aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-Fourth transition duration-75  group-hover:text-Fourth" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M3 3a1 1 0 00-1 1v12a1 1 0 102 0V4a1 1 0 00-1-1zm10.293 9.293a1 1 0 001.414 1.414l3-3a1 1 0 000-1.414l-3-3a1 1 0 10-1.414 1.414L14.586 9H7a1 1 0 100 2h7.586l-1.293 1.293z" clipRule="evenodd"></path></svg>
